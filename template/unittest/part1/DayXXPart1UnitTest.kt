...
internal class Day{d2}Part1UnitTest {
    ...
    companion object {
        ...
        fun provide(): Stream<Arguments> {
            return Stream.of(
                Arguments.of(input_d{d1}_p1_1, result_d{d1}_p1_1),
                Arguments.of(input_d{d1}_p1_2, result_d{d1}_p1_2),
                Arguments.of(input_d{d1}_p1_3, result_d{d1}_p1_3),
